...
BATCH_PREDICTION_RESULTS_DIRECTORY     = get_project_root() / "app" / "endpoints" / "download_predictions" / "tmp" / "batch_results_file"         
INDIV_PREDICTION_RESULTS_DIRECTORY     = get_project_root() / "app" / "endpoints" / "download_individual_prediction" / "tmp" / "results_files"                         
